...
export default {
  ...
  data() {
    return {
      ...
      date: Date.now() + 6000,
      countButtons: 3,
      title: 'Wie viele Seepferdchen siehst du? Klicke auf das passende Würfelbild.',
      audioDuration: 6000,
      gameName: 'Abzaehlen_Two',
      showDemo: true,
      randomIndex: 0,
      solutions: 0,
      //showDuration: 2400,
  ...
  methods: {
    ...
    randomNumber: function () {
      this.randomIndex = Math.ceil((Math.random()*3)-1)
    ...
    switchToNext: function() {
      this.$router.push({ path: '/tutoring/vorschule/abzaehlen_three' });
    },
...
.backgroundFadeIn {
  background-image: url('../../assets/abzaehlen_two/background.svg');
  background-size: cover;
  height: 100%;
  width: 100%;
  position: absolute;
