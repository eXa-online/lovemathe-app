...
export default {
  ...
  data() {
    return {
      ...
      date: Date.now() + 6000,
      countButtons: 4,
      title: 'Wie viele Quallen siehst du? Klicke auf das passende Würfelbild.',
      audioDuration: 6000,
      gameName: 'Abzaehlen_Three',
      showDemo: true,
      randomIndex: 0,
      solutions: 0,
      //showDuration: 2400,
  ...
  methods: {
    ...
    randomNumber: function () {
      this.randomIndex = Math.ceil((Math.random()*4)-1)
    ...
    switchToNext: function() {
      this.$router.push({ path: '/tutoring/vorschule/abzaehlen_four' });
    },
...
.backgroundFadeIn {
  background-image: url('../../assets/abzaehlen_three/background.svg');
  background-size: cover;
  height: 100%;
  width: 100%;
  position: absolute;
