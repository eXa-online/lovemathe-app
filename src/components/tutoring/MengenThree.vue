...
export default {
  ...
  data() {
    return {
      ...
      countButtons: 2,
      countButtons2: 6,
      title: 'Siehst du mehr Flaschen oder mehr Wale, klicke auf das richtige Bild!',
      title2: 'Wieviele mehr mehr kannst du erkennen?',
      audioDuration: 6000,
      gameName: 'Mengen_Three',
      showDemo: true,
      randomIndex: 0,
      solutions: 0,
      level: 3,
  ...
  methods: {
    ...
    randomNumber: function () {
      this.randomIndex = Math.ceil((Math.random()*10)-1)
