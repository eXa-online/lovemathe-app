...
export default {
  ...
  data() {
    return {
      ...
      countButtons: 2,
      countButtons2: 6,
      title: 'Siehst du mehr Seepferdchen oder mehr Tintenfische, klicke auf das richtige Bild!',
  ...
  methods: {
    ...
    evalSelection(givenSolution) {
      if (this.preventDoubleClick()) {
        if(this.randomIndex === 0 || this.randomIndex === 1 || this.randomIndex === 2) {
          this.solutions = 1
        }
        if(this.randomIndex === 3 || this.randomIndex === 4 || this.randomIndex === 5) {
          this.solutions = 0
        }
    ...
    evalSelection2(givenSolution2) {
      if (this.preventDoubleClick()) {
        if(this.randomIndex === 0 || this.randomIndex === 2 || this.randomIndex === 3 || this.randomIndex === 5) {
          this.solutions = 0
        }
        if(this.randomIndex === 1 || this.randomIndex === 4) {
          this.solutions = 1
        }
    ...
    switchToNext: function() {
      this.$router.push({ path: '/tutoring/vorschule/mengen_three' });
    },
...
.backgroundFadeIn {
  background-image: url('../../assets/mengen_two/background.svg');
  background-size: cover;
  height: 100%;
  width: 100%;
  position: absolute;
