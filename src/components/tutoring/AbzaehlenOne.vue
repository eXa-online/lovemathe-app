...
export default {
  ...
  data() {
    return {
      ...
      date: Date.now() + 6000,
      countButtons: 2,
      title: 'Wie viele Muscheln siehst du? Klicke auf das passende Würfelbild.',
      audioDuration: 6000,
      gameName: 'Abzaehlen_One',
      showDemo: true,
      randomIndex: 0,
      solutions: 0,
      //showDuration: 2400,
  ...
  methods: {
    ...
    switchToNext: function() {
      this.$router.push({ path: '/tutoring/vorschule/abzaehlen_two' });
    },
