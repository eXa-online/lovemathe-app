...
export default {
  name: 'SimultanerfassungSix',
  data() {
    return {
      completed: false,
      badgeIndex: 0,
      gamePath: 'simultanerfassung_six',
      puzzleIndex: 0,
      ...
      date: Date.now() + 6000,
      countButtons: 6,
      title: 'Du siehst das Bild nur für eine kurze Zeit. Wie viele Seesterne kannst du erkennen?',
      audioDuration: 6000,
      gameName: 'Simultanerfassung_Six',
      showDemo: true,
      randomIndex: 0,
      solutions: 0,
      showDuration: 800,
...
.backgroundFadeIn {
  background-image: url('../../assets/simultanerfassung_six/background.svg');
  background-size: cover;
  height: 100%;
  width: 100%;
  position: absolute;
