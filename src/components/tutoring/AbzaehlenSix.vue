...
export default {
  ...
  data() {
    return {
      ...
      date: Date.now() + 6000,
      countButtons: 6,
      title: 'Wie viele Schatztruhen siehst du? Klicke auf das passende Würfelbild.',
      audioDuration: 6000,
      gameName: 'Abzaehlen_Six',
      showDemo: true,
      randomIndex: 0,
      solutions: 0,
      //showDuration: 2400,
...
.activeBackground {
  background-image: url('../../assets/abzaehlen_five/background.svg');
...
.backgroundFadeIn {
  background-image: url('../../assets/abzaehlen_six/background.svg');
  background-size: cover;
  height: 100%;
  width: 100%;
  position: absolute;
