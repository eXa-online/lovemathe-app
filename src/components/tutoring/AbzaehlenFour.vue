...
export default {
  ...
  methods: {
    ...
    randomNumber: function () {
      this.randomIndex = Math.ceil((Math.random()*5)-1)
    ...
    switchToNext: function() {
      this.$router.push({ path: '/tutoring/vorschule/abzaehlen_five' });
    },
...
.backgroundFadeIn {
  background-image: url('../../assets/abzaehlen_four/background.svg');
  background-size: cover;
  height: 100%;
  width: 100%;
  position: absolute;
