...
export default {
  name: 'OrientierungFour',
  data() {
    return {
      completed: false,
      badgeIndex: 0,
      gamePath: 'orientation_four',
      puzzleIndex: 0,
  ...
  methods: {
    ...
    switchToNext: function() {
      this.$router.push({ path: '/tutoring/vorschule/orientierung_five' });
    },
...
.puzzle_body_background {
  background-image: url('../../assets/orientation_four/background.svg');
  margin-top: 50px;
  width: 50vw;
