...
export default {
  name: 'OrientierungThree',
  data() {
    return {
      completed: false,
      badgeIndex: 0,
      gamePath: 'orientation_three',
      puzzleIndex: 0,
  ...
  methods: {
    ...
    switchToNext: function() {
      this.$router.push({ path: '/tutoring/vorschule/orientierung_four' });
    },
...
.puzzle_body_background {
  background-image: url('../../assets/orientation_three/background.svg');
  margin-top: 50px;
  width: 50vw;
...
.activeBackground {
  background-image: url('../../assets/orientation_two/background.svg');
